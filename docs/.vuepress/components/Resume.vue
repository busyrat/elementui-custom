...
.resume-page
  ...
  .main
    ...
    .box
      .period
        .time 2017.08-2019.04
        .location 聚光科技（杭州）股份有限公司
        .other 前端工程师
      .content 
        p 工作描述:
        ul
    ...
    .box
      .period
        .time 2019.07-2019.07
        .location
          a(href="https://github.com/busyrat/html-webpack-iconfont-plugin") html-webpack-iconfont-plugin
        .other webpack
      .content
        .content-item 主要工作：
          ol.flex1
